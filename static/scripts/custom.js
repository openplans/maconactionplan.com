$(function(){
  ...
  var $header = $('.project-header'),
      socialbuttons = 
        ...
        '  <li><a class="" href="https://www.facebook.com/pages/Macon-Action-Plan/264633970391707" target="_blank"><img src="images/social-facebook.gif"></a></li>' +
        '  <li><a class="" href="http://instagram.com/MaconActionPlan" target="_blank"><img src="images/social-instagram.gif"></a></li>' +
        '  <li><a class="" href="http://twitter.com/MaconActionPlan" target="_blank"><img src="images/social-twitter.gif"></a></li>' +
        '</ul>';
